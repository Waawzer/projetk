...
const BlackHoleLogo: React.FC<BlackHoleLogoProps> = ({ 
  className = '', 
  size = 24,
  mobileSize
}) => {
  // Utiliser la taille mobile si elle est fournie, sinon utiliser 80% de la taille normale
  const mobileSizeValue = mobileSize || Math.round(size * 0.8);
  ...
  return (
    <>
      ...
      <svg 
        xmlns="http://www.w3.org/2000/svg" 
        width={mobileSizeValue} 
        height={mobileSizeValue} 
        viewBox="0 0 24 24" 
        fill="none" 
        stroke="currentColor" 
        strokeWidth="2" 

...
const examplePricingPlans: PricingPlan[] = [
  {
    ...
    price: 60,
    description:
      "Idéal pour les artistes souhaitant enregistrer leurs morceaux avec un équipement professionnel.",
    features: [
  ...
  },
  {
    ...
    price: 120,
    description:
      "Notre formule la plus populaire pour une production professionnelle de A à Z.",
    features: [
      { text: "Studio acoustique traité", included: true },
      { text: "Microphones haut de gamme", included: true },
      { text: "Ingénieur du son", included: true },
  ...
  },
  {
    ...
    price: 50,
    description:
      "Pour les artistes ayant déjà enregistré leurs pistes et souhaitant un mixage professionnel.",
    features: [
      { text: "Mixage professionnel", included: true },
  ...
  },
  {
    ...
    price: 40,
    description:
      "La touche finale pour donner à votre musique un son professionnel prêt pour la distribution.",
    features: [
  ...
  useEffect(() => {
    const fetchPricingPlans = async () => {
      try {
        ...
        if (!response.ok) {
          console.warn(
            "Impossible de récupérer les tarifs depuis l'API, utilisation des données d'exemple"
          );
        ...
        if (!data || data.length === 0) {
          console.warn(
            "Aucun tarif retourné par l'API, utilisation des données d'exemple"
          );
          setPricingPlans(examplePricingPlans);
          return;
        }
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
              Des formules adaptées à tous vos besoins musicaux, avec un
        ...
        <div className="container mx-auto px-4">
            ...
            {pricingPlans.map((plan, index) => (
              ...
              >
                ...
                <div className="p-6 bg-card backdrop-blur-sm">
                  ...
                  <Link
                    href="/reservation"
                    className={`block w-full py-3 px-4 rounded-xl font-medium text-center transition-all duration-300 ${
                      plan.popular
          ...
          >
            <p className="text-gray-400 mb-6">
              Tous nos tarifs sont indiqués par heure. Des forfaits pour
              demi-journée (6h) et journée complète (10h) sont disponibles avec
              des réductions.
            </p>
            <Link
              href="/contact"
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                Notre studio est équipé des dernières technologies audio pour
                garantir une qualité sonore irréprochable. Nos ingénieurs du son
                expérimentés vous accompagnent tout au long du processus pour
                donner vie à votre vision musicale.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4 md:space-y-6">
            {[
              {
                question:
                  "Comment se déroule une session d&apos;enregistrement ?",
                answer:
              ...
              {
                question:
                  "Combien de temps faut-il pour enregistrer une chanson ?",
                answer:
              ...
              {
                question:
                  "Quel est le délai pour recevoir les fichiers finaux ?",
                answer:
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-gray-300 max-w-3xl mx-auto mb-6 md:mb-8">
              Réservez dès maintenant une session dans notre studio et
              bénéficiez de notre expertise pour réaliser votre vision musicale.
            </p>
          </motion.div>
